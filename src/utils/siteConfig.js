module.exports = {
    siteUrl: `https://static.jcode.me`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `Adventures of a Technomancer`, // Used for App manifest e.g. Mobile Home Screen
