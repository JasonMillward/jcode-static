! function(B, i) {
    ...
    var t, r, E, c, a = "commento",
        ...
        re = "https://commento.jcode.me",
        ce = "https://commento.jcode.me",
        ae = null,
    ...
    var wo = !(B.main = function(e) {
        if (null !== (ae = Se(a))) {
            null === Me && (Me = ae.getBoundingClientRect().width < 450), De(ae, "root"), "true" !== r && De(ae, "root-font"),
                ...
                function() {
                    var e = Re("div");
                    e.id = s, De(e, "error-box"), qe(e, "style", "display: none;"), Be(ae, e)
                }(),
                function() {
                    var e = Re("div");
            ...
            var o = function() {
                var e = Re("div"),
                    ...
                    n = Re("a"),
                    t = Re("span");
                return e.id = "commento-footer", De(e, "footer"), De(o, "logo-container"), De(n, "logo"), De(t, "logo-text"), qe(n, "href", "https://commento.io"), qe(n, "target", "_blank"), t.innerText = "Commento", Be(n, t), Be(o, n), Be(e, o), e
            }();
